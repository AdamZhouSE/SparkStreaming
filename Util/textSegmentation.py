...
def filter(seg_list):
    """
    对分词结果按停用词表和自定义词典进行一次筛选
    只挑选名词且不是停用词的 或 在自定义词表中的内容
    :param seg_list: 分词结果
    :return:
    """
    result=[]
...
if __name__ == "__main__":
    segment("选调，我又被吓到，然后我再看书就看不进去了??整个人就崩溃了??我有想过换到图书馆，可是我书很多，图书馆现在也没有考研书柜可以给我用了。所以我基本上只能在考研教室学习??我不是酸她，我只是希望她在考研期间不要来找我，也不要来考研教室，不要和我一起吃饭??虽然我知道我的想法很自私，要别人迁就我，还很玻璃心，对不起！对不起！对不起！??可是我现在真的很崩溃，有人可以给我一些建议吗？")
